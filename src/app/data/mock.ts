...
const users: User[] = [
  ...
  },
  {
    ...
    lastActive: '2小时前',
    identity: '自由职业',
    bio: '全栈工程师，精通React/Node.js/Python，喜欢做有趣的副业项目。',
    skills: [
      { name: 'React', level: '专业' },
      { name: 'Node.js', level: '专业' },
      { name: 'Python', level: '熟练' },
      { name: '小程序', level: '熟练' },
    ],
    completedProjects: 32,
    fulfillmentRate: 95,
    responseTime: '通常2小时内回复',
    tags: ['技术强', '高效'],
  },
  {
    id: 'u4',
    ...
    lastActive: '刚刚',
    identity: '自由职业',
    bio: '小红书/B站内容创作者，擅长种草文案和短视频脚本撰写。',
    skills: [
      { name: '文案撰写', level: '专业' },
      { name: '短视频', level: '熟练' },
      { name: '小红书运营', level: '专业' },
  ...
  },
  {
    ...
    lastActive: '1小时前',
    identity: '学生',
    bio: '大四影视专业学生，熟练使用PR/AE/达芬奇，承接各类视频剪辑。',
    skills: [
      { name: '视频剪辑', level: '专业' },
      { name: 'AE特效', level: '熟练' },
      { name: '调色', level: '熟练' },
...
export const MOCK_TASKS: Task[] = [
  {
    ...
    deadline: '2026-04-15',
    location: '远程',
    skillRequirements: ['品牌设计', 'UI设计', '插画'],
  },
  {
    id: 't2',
    title: '小程序前端开发（电商类）',
    ...
    deadline: '2026-03-25',
    location: '远程',
    skillRequirements: ['小程序', 'React', 'TypeScript'],
  },
  {
    id: 't3',
    title: '小红书种草文案撰写（长期）',
  ...
  },
  {
    ...
    deadline: '2026-03-10',
    location: '远程',
    skillRequirements: ['视频剪辑', 'AE特效', '调色'],
  },
  {
    id: 't5',
    title: '二次元IP形象设计',
  ...
  },
  {
    ...
    deadline: '2026-05-01',
    location: '深圳优先',
    skillRequirements: ['React', 'Node.js', 'TypeScript'],
  },
];
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    reviewer: users[0],
    rating: 5,
    content: '非常专业的设计师！沟通顺畅，交付质量超出预期，改稿耐心细致，下次还合作！',
    project: '品牌VI设计',
  ...
  },
  {
    ...
    reviewer: users[1],
    rating: 5,
    content: '效率很高，一周内完成了全部页面设计，风格把握准确，推荐！',
    project: '电商App设计',
  ...
  },
  {
    ...
    reviewer: users[2],
    rating: 4,
    content: '整体不错，创意很好，就是时间上稍微有点赶，但最终成品很满意。',
    project: '小红书运营物料',
  ...
  },
  {
    ...
    reviewer: users[3],
    rating: 5,
    content: '合作非常愉快，对需求理解到位，出品速度快，强烈推荐！',
    project: '产品宣传海报',
...
export const PORTFOLIO_IMAGES: Record<string, string[]> = {
  'tal1': [
    'https://images.unsplash.com/photo-1760071744047-5542cbfda184?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1616205255812-c07c8102cc02?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1618761714954-0b8cd0026356?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1748801583975-720cb5e4985e?w=400&h=300&fit=crop',
  ],
  'tal2': [
    'https://images.unsplash.com/photo-1618761714954-0b8cd0026356?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1748801583975-720cb5e4985e?w=400&h=300&fit=crop',
  ...
  'tal3': [
    'https://images.unsplash.com/photo-1760071744047-5542cbfda184?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1668775589980-58f9f0021ce5?w=400&h=300&fit=crop',
  ],
  'tal4': [
    'https://images.unsplash.com/photo-1736175549681-c24c552da1e2?w=400&h=300&fit=crop',
    'https://images.unsplash.com/photo-1668775589980-58f9f0021ce5?w=400&h=300&fit=crop',
  ],
  'tal5': [
    'https://images.unsplash.com/photo-1736175549681-c24c552da1e2?w=400&h=300&fit=crop',
...
export const MOCK_TALENTS: Talent[] = [
  {
    id: 'tal1',
    user: CURRENT_USER,
    acceptTypes: ['UI设计', '品牌设计', '插画'],
    matchScore: 95,
    portfolio: [],
    hourlyRate: '200-400',
    description: '5年专业UI/UX设计经验，服务过多个互联网头部产品，擅长移动端体验设计与品牌视觉系统搭建。追求像素级完美，注重用户体验细节。',
  },
  {
    id: 'tal2',
    user: users[1],
    acceptTypes: ['全栈开发', '小程序', 'Web应用'],
    matchScore: 82,
    portfolio: [],
    hourlyRate: '300-500',
    description: '全栈工程师，8年开发经验，精通React/Node.js/Python技术栈。热爱技术，擅长将复杂需求拆解为清晰的技术方案。',
  },
  {
    id: 'tal3',
    user: users[2],
    acceptTypes: ['文案', '内容策划', '社媒运营'],
    matchScore: 76,
    portfolio: [],
    hourlyRate: '150-300',
    description: '资深内容创作者，小红书/B站双平台达人，多篇爆款笔记经验。擅长种草文案、品牌故事叙述和社媒内容策划。',
  },
  {
    id: 'tal4',
    user: users[3],
    acceptTypes: ['视频剪辑', '短视频', '后期制作'],
    matchScore: 68,
    portfolio: [],
    hourlyRate: '100-250',
    description: '影视专业科班出身，精通PR/AE/达芬奇，擅长商业宣传片、短视频和Vlog剪辑。注重画面质感与节奏把控。',
  },
  {
    id: 'tal5',
    user: users[4],
    acceptTypes: ['插画', 'IP设计', '漫画'],
    matchScore: 91,
    portfolio: [],
    hourlyRate: '250-500',
    description: '自由插画师，二次元风格为主，也接商业插画和IP形象设计。画风治愈可爱，曾为多个知名IP创作过官方周边。',
  },
  {
    id: 'tal6',
    user: users[0],
    acceptTypes: ['品牌策划', '视觉设计', '市场推广'],
    matchScore: 85,
    portfolio: [],
    hourlyRate: '350-600',
    description: '专注品牌全案策划10年+，从品牌定位到视觉落地一站式服务。为100+品牌提供过成功的品牌升级方案。',
  },
];
...
export const MOCK_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    lastMessage: '恭喜！你的任务"新茶饮品牌VI设计"收到了新的申请',
...
export const SKILL_CATEGORIES = [
  '全部', 'UI设计', '视频剪辑', '文案', '开发', '插画', '品牌', '小红书', '短视频', '摄影', '翻译', '音乐',
];
